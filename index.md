...
```
### Random Meal Generator (JavaScript)

This program takes in a set of meal items with names and prices, then randomly generates a menu from that which it will print to the console
...
### Cipher for coding a message (C#)

A simple C# program which takes a string as an input and converts that string into a coded message
